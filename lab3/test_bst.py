# python -m unittest test_bst.BSTTestCase.test_add
import unittest
...
class BSTTestCase(unittest.TestCase):
    ...
    def test_remove(self):
        ...
        self.assertListEqual(self.bst.inorder_walk(), [1, 5, 8, 30, 45, 52])
        self.assertListEqual(self.bst.preorder_walk(), [8, 5, 1, 52, 30, 45])
